...
import { cadastrar } from "../services/usuario/cadastrar";
...
export default function Cadastro() {
    ...
    async function onFormSubmit() {
        ...
        try {
            ...
            Alert.alert("Não foi possível entrar", err?.message || "Confira seus dados e tente novamente.");
        } finally {
            setCarregando(false);
        }
    }
            ...
            >
                ...
                >
                    ...
                    <Text style={styles.subtitulo}>
                        Cadastre-se para descobrir novos livros.
                    </Text>
